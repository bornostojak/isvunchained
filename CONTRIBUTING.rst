...
Welcome to ``isvunchained`` contributor's guide.
...
If you experience bugs or general issues with ``isvunchained``, please have a look
...
You can help improve ``isvunchained`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``isvunchained`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``isvunchained``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/isvunchained.git
    cd isvunchained
...
#. Install |pre-commit|_::
   ...
   ``isvunchained`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/isvunchained
.. _issue tracker: https://github.com/<USERNAME>/isvunchained/issues
.. <-- end -->
